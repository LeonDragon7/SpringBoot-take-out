...
public class EmployeeController {
    ...
    @ApiOperation("员工分页查询")
    @GetMapping("/page")
    public Result<PageResult> index(EmployeePageQueryDTO queryDTO){
        log.info("员工分页查询：{}",queryDTO);
        PageResult employeeModel = employeeService.pageList(queryDTO);
        return Result.success(employeeModel);
    }
